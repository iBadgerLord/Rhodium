...
public class GrandRegeneration extends GrandPotionItem {
    ...
    public ItemStack finishUsing(ItemStack stack, World world, LivingEntity user) {
        ...
        if (!world.isClient) {
            ...
            user.addStatusEffect(new StatusEffectInstance(StatusEffects.REGENERATION, 1800, 2));
    ...
    public void appendTooltip(ItemStack itemStack, World world, List<Text> tooltip, TooltipContext tooltipContext) {
        tooltip.add( new TranslatableText("item.rhodium.grand_regeneration_potion.tooltip1").formatted(Formatting.BLUE) );
    }
